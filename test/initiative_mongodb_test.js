...
async function Test_Function()
{
  ...
  try {
    ...
    var initiative_DB = await load_InitiativeDB('./public/json/initiative_DB_46093_Latest.json');
    //var initiative_DB = await load_InitiativeDB('./public/json/initiative_DB_TVPLAT-16376_Latest.json');
    //console.log("initiative_DB = ", initiative_DB);
    
    var initiative_doc = { inserted_at : today, Snapshot_at : initiative_DB['snapshotDate'], platform : 'webOS50_Initial', json: initiative_DB };
    // 1. Create
    //InitMgr_webOS45_MR_Minor_DB.insert(initiative_doc);
    InitMgr_webOS50_Initial_DB.insert(initiative_doc);
